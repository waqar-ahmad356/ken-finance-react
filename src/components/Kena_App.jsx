        ...
        <div className='flex flex-col items-center md:flex-row md:gap-[120px] lg:gap-[256px] gap-8'>
            ...
            <p className='text-[32px] text-[#db0011] font-semibold'>Step 1</p>
                ...
                <div className='flex items-center md:gap-6 gap-4 ' >
                    <span className='rounded-[50%] flex text-[24px] text-[#F4B0B5] justify-center items-center p-[10px] border-[2px] border-[#F4B0B5] w-[48px] h-[48px]'>&gt;</span>
                    <span className='rounded-[50%] text-[#dd0011] text-[24px] flex justify-center items-center p-[10px] border-[2px] border-[#dd0011] w-[48px] h-[48px]'>&lt;</span>
                </div>
            </div>
            <div>
